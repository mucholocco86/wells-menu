...
screen wells_menu_language():
    ...
    frame:
                        ...
                        viewport:
                            ...
                            vbox spacing 8 xfill True:
                                ...
                                textbutton "Reset Font":
                                    ...
                                    text_size 24 text_hover_color "#ff4444"
        ...
        # Botão PERFORMANCE
        imagebutton:
            xpos 180 ypos 650 xanchor 0.5
            idle "wells/gui/btn_idiomas_idle.png"
            hover "wells/gui/btn_idiomas_hover.png"
        ...
        imagebutton:
            ...
            idle "wells/gui/btn_performance_idle.png"
            hover "wells/gui/btn_performance_hover.png"
        ...
        imagebutton:
            ...
            idle "wells/gui/btn_dialogo_idle.png"
            hover "wells/gui/btn_dialogo_hover.png"
            action [Show("dialogue_adjusts"), Hide("wells_menu_language")]
            alt "Ajustes de Diálogo"

        # Botão FECHAR
        imagebutton:
            xpos 900 ypos 650 xanchor 0.5
            idle "wells/gui/btn_fechar_menu_idle.png"
            hover "wells/gui/btn_fechar_menu_hover.png"
...
screen idioma_seletor():
    ...
    frame:
        ...
        # --- BOTÃO VOLTAR SUBST. POR IMAGEM ---
        imagebutton:
            xpos 900 ypos 590 xanchor 0.5
            idle "wells/gui/btn_voltar_menu_idle.png"
            hover "wells/gui/btn_voltar_menu_hover.png"
...
################################################################################
## NOVO QUICK MENU (SISTEMA DE ALTERNÂNCIA - IMAGENS SUBSTITUÍDAS)
################################################################################
...
# --- O BOTÃO DISPARADOR (AGORA COMO IMAGEBUTTON) ---
screen quick_menu():
    zorder 100
    if quick_menu:
        mousearea:
        ...
        if not renpy.get_screen("custom_menu_wells"):
            if quick_menu_hovered:
                imagebutton:
                    xpos 14 yanchor 1.0 ypos 1.0
                    idle "wells/gui/btn_quick_idle.png"
                    hover "wells/gui/btn_quick_hover.png"
                    action Show("custom_menu_wells")
                    alt "Abrir Quick Menu"
# --- A CAIXINHA COM OS BOTÕES (MENU ABERTO - TEXTOS POR IMAGENS EM wells/gui/) ---
screen custom_menu_wells:
    ...
    frame:
        at wells_float_left
        background Frame("wells/gui/quick_aberto.png", 10, 10)
        xpos 14 yanchor 1.0 ypos 1.0 
        padding (25, 18, 30, 2)
        ...
        hbox:
            ...
            imagebutton:
                idle "wells/gui/btn_fechar_idle.png"
                hover "wells/gui/btn_fechar_hover.png"
                action Hide("custom_menu_wells")
                alt "Fechar Menu"

            imagebutton:
                idle "wells/gui/btn_voltar_idle.png"
                hover "wells/gui/btn_voltar_hover.png"
                action [Rollback(), Hide("custom_menu_wells")]
                alt "Voltar Linha"

            imagebutton:
                idle "wells/gui/btn_pular_idle.png"
                hover "wells/gui/btn_pular_hover.png"
                action [Skip(), Hide("custom_menu_wells")] 
                alternate Skip(fast=True, confirm=True)
                alt "Pular Diálogo"

            imagebutton:
                idle "wells/gui/btn_salvar_idle.png"
                hover "wells/gui/btn_salvar_hover.png"
                action ShowMenu("save")
                alt "Salvar Jogo"

            imagebutton:
                idle "wells/gui/btn_carregar_idle.png"
                hover "wells/gui/btn_carregar_hover.png"
                action ShowMenu("load")
                alt "Carregar Jogo"

            imagebutton:
                idle "wells/gui/btn_opcoes_idle.png"
                hover "wells/gui/btn_opcoes_hover.png"
                action ShowMenu("preferences")
                alt "Opções"

            imagebutton:
                idle "wells/gui/btn_menu_idle.png"
                hover "wells/gui/btn_menu_hover.png"
                action Show("wells_menu_language")
                alt "Menu Universal"

            # botão que servira de atalho para o mod adicional.
            imagebutton:
                idle "wells/gui/btn_teste_idle.png"
                hover "wells/gui/btn_teste_hover.png"
                action Show("")
                alt ""
