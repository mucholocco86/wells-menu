...
init 999 python:
    ...
    config.default_language = "pt_br_zenpy"
...
screen dialogue_adjusts():
    ...
    frame:
            ...
            vbox:
                ...
                vbox:
                    ...
                    button:
                        ...
                        text _("Pular Texto") xalign 0.5 yalign 0.5 size 22 hover_color "#2bff00"

                    # --- BOTÃO 2: APÓS ESCOLHAS ---
                    button:
                        padding (0, 0, 0, 0)
                        xysize (180, 45)
                        idle_background Frame("wells/gui/Button-idle.png", 5, 5)
                        ...
                        text _("Após Escolhas") xalign 0.5 yalign 0.5 size 22 hover_color "#2bff00"
                    ...
                    button:
                        ...
                        text _("Transições") xalign 0.5 yalign 0.5 size 22 hover_color "#2bff00"
                ...
                vbox:
                    ...
                    button:
                        ...
                        text _("Desabilitado") xalign 0.5 yalign 0.5 size 22 hover_color "#2bff00"
                    ...
                    button:
                        ...
                        text _("Esquerda") xalign 0.5 yalign 0.5 size 22 hover_color "#2bff00"
                    ...
                    button:
                        ...
                        text _("Direita") xalign 0.5 yalign 0.5 size 22 hover_color "#2bff00"

                # Seção SISTEMA DE DIÁLOGO DUPLO
                vbox:
                    spacing 10
                ...
                vbox:
                    ...
                    button:
                        ...
                        text _("Padrão") xalign 0.5 yalign 0.5 size 22 hover_color "#2bff00"

                    # --- BOTÃO 8: CAMALEÃO NOVO/HIM ---
                    button:
                        padding (0, 0, 0, 0)
                        xysize (180, 45)
                        idle_background Frame("wells/gui/Button-idle.png", 5, 5)
                        ...
                        text _("Camaleão") xalign 0.5 yalign 0.5 size 22 hover_color "#2bff00"

                    # --- BOTÃO 9: DUAL DIALOGUE (CORRIGIDO) ---
                    button:
                        padding (0, 0, 0, 0)
                        xysize (180, 45)
                        idle_background Frame("wells/gui/Button-idle.png", 5, 5)
                        ...
                        # Correção: Mudado 'text_color' para 'color' para o Ren'Py aceitar a regra de cor dinâmica
                    ...
                    button:
                        ...
                        text "Diag. Fix: [persistent.wells_dual_dialogue_fix]" xalign 0.5 yalign 0.5 size 22 color "#42bef8" hover_color "#2bff00"
        ...
        button:
            ...
            xpos 550 ypos 590 xanchor 0.5 # Mantém a posição original dele na tela
        ...
        draggroup:
            drag:
                ...
                frame:
                    ...
                    # TROCADO: Sai o imagebutton antigo e entra o botão de texto inteligente
                    button:
                        padding (0, 0, 0, 0)
                        
                        # Defina aqui o tamanho exato da imagem do seu botão azul pequeno (Ex: 80 largura, 35 altura)
                        xysize (68, 38) 
                        
                        # Use as imagens de fundo do seu botão pequeno (vazio, sem texto)
                        idle_background Frame("wells/gui/Button-idle.png", 3, 3)
                        hover_background Frame("wells/gui/Button-hover.png", 3, 3)
                        
                        # Abre a tela de pausa centralizada
                        action [Hide("quick_menu"), Show("quick_mod")]
                        
                        # O texto real que vai ficar escrito no meio do botão azul
                        text _("Quick") xalign 0.5 yalign 0.5 size 20 hover_color "#2bff00"

################################################################################
## PARTE 2: A NOVA TELA DE PAUSA CENTRALIZADA (ESTILO BRIGHT LORD)
################################################################################
screen quick_mod():
    zorder 250          # Fica por cima de tudo
        ...
        frame:
            ...
            vbox:
                ...
                button:
                    ...
                    idle_background Frame("wells/gui/Button-idle.png", 5, 5)
                    hover_background Frame("wells/gui/Button-hover.png", 5, 5)
                    action [Skip(), Hide("quick_mod"), Show("quick_menu")] 
                ...
                button:
                    ...
                    idle_background Frame("wells/gui/Button-idle.png", 5, 5)
                    hover_background Frame("wells/gui/Button-hover.png", 5, 5)
                    action [Show("wells_menu_language"), Hide("quick_mod"), Show("quick_menu")] 
                    xalign 0.5
                ...
                button:
                    ...
                    idle_background Frame("wells/gui/Button-idle.png", 5, 5)
                    hover_background Frame("wells/gui/Button-hover.png", 5, 5)
                    action [Show("mod_menu"), Hide("quick_mod"), Show("quick_menu")] 
                    xalign 0.5
                    text _("Mod Menu") xalign 0.5 yalign 0.5 size 22 hover_color "#2bff00"
