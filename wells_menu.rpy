...
# 2. O Botão Disparador (VERSÃO FINAL AJUSTADA)
screen quick_menu():
    zorder 100
    if quick_menu:
        if not renpy.get_screen("custom_menu_wells"):
            button:
                ...
                # O valor 25 embaixo sobe o texto para não bater no fundo da tela
                padding (16, 5, 16, 5)
                ...
                text "QUICK":
                    ...
                    size 22
                    xalign 0.5 # Centraliza o texto no meio da imagem
                    yalign 0.5
...
screen custom_menu_wells:
    ...
    frame:
        ...
        # Aumentamos o valor final (25) para empurrar o texto para cima do chão da tela
        padding (25, 18, 30, 2)
        
        hbox:
            spacing 25
            yalign 0.5 # Centraliza verticalmente dentro da área do padding
...
# --- Ajuste Extra no Estilo ---
style wells_menu_quick_button_text:
    # Reduzi um pouco o tamanho para caber melhor na barra
    size 22 
    color "#FFFFFF"
